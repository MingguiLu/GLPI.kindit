...
Class Down_Param
		...
		Sub Kesion()
		 With KS
			...
			.echo "    <tr>"
			.echo "      <td width=""25%"" class='tdbg' style='padding:10px'><strong>功能说明：</strong>"
			.echo "       本操作能自动检测文档是否有关键词Tags，如果没有设置的自动按文档标题自动生成关键词Tags.<br/><br/>"
			.echo "      <table border='0' width='98%' align'center'>"
			.echo "       <tr><td><input type='button' onclick=""if (parseInt($('#channelid').val())!=0){relativeDoc('begin','setKeyWords','自动设置关键字');}else{alert('请选择模型!');}"" class='button' value='一键设置关键字'></td></tr>"
			.echo "      </table>"
			.echo "        </td>"
			.echo "    </tr>"
			.echo "  </table>"
