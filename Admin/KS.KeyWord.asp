...
Class Admin_KeyWord
		...
		Sub KeyWordList()			
			...
			<script language="javascript">
				...
				function KeyWordAdd()
				{
					new KesionPopup().PopupCenterIframe('新增关键字Tags','KS.KeyWord.asp?Action=Add',530,110,'no')
				}
				function EditKeyWord(id)
				{	
				   new KesionPopup().PopupCenterIframe('新增关键字Tags','KS.KeyWord.asp?Page='+Page+'&Action=Edit&ID='+id,530,110,'no')
