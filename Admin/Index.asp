...
Class Admin_Index
		...
		.Write "<frameset rows=""40,*,38"" border=""0"" frameborder=""0"" framespacing=""0"">" & vbcrlf
		...
		.Write "            <frame src=""Index.asp?action=Main""  noresize name=""MainFrame"" id=""MainFrame"" frameborder=""no"" scrolling=""auto"" marginwidth=""0"" marginheight=""0""></frame>" & vbCrLf
		.Write "            <frame src=""KS.Split.asp?ButtonSymbol=Disabled&OpStr=" & Server.URLEncode("系统管理中心 >> 首页") & """ name=""BottomFrame"" ID=""BottomFrame"" frameborder=""no"" scrolling=""no"" marginwidth=""0"" marginheight=""0""></frame>" & vbCrLf
		...
		Public Sub KS_Head()
			...
			.Write "</head>"
			.Write "<body leftmargin=""0"" style=""overflow:hidden"" topmargin=""0"" marginwidth=""0"" marginheight=""0"" scroll=""no"" class=""head"">"
			...
			.Write "          <tr>"
			.Write "            <td width='220'><font class='logo'>&nbsp;&nbsp;KesionCMS V7.0</font></td>"
			...
			.Write "                <td class=""font_text"" align=""right""> [<a href=""" & KS.GetDomain &""" target=""_blank"" class=""white"">网站首页</a>] [<a href=""" & KS.GetDomain &"User/User_Message.asp?action=inbox"" target=""_blank"" class=""white"">查看短信</a><span id='newmessage'>(<font color=#ff0000>0</font>)</span>] "
       ...
       Next
		...
		<head><title>科汛网站管理系统V7.0后台</title>
		<meta http-equiv=Content-Type content="text/html; charset=gb2312">
		<link href="images/frame.css" type=text/css rel=stylesheet>
		</head>
		  ...
		  <tr vAlign=top>
			...
			<td align="center" class="boxright">
			   ...
			   End If
					...
					<li><a href="KS.GuestBook.asp?Action=Main"  target="MainFrame" title="论坛帖子管理">论坛帖子管理</a>  <a href="KS.GuestBook.asp?Action=Recycle"  target="MainFrame" title="帖子回收站">回收站</a></li>
					...
					<li><a href="KS.GuestTable.asp"  target="MainFrame" title="当前数据表管理">当前数据表管理</a></li>
					   ...
					   <li><a href="javascript:void(0)" onClick="SelectObjItem1(this,'问答系统 >> <font color=red>等级头衔设置</font>','Disabled','KS.AskGrade.asp?typeflag=1');" title="等级头衔设置">等级头衔设置</a></li>
					   <%end if%>
					<%end if%>
			  ...
			  success: function(d){
					...
					switch (d){
					 ...
					 default:
					    ...
					    new KesionPopup().popupTips('系统检查到有可升级文件',str,510,300);
          ...
          <%
			...
			Public Sub KS_Foot()
		     With Response
				...
				.Write "<META http-equiv=Content-Type content=""text/html; charset=gb2312"">"
		        .Write "<link href=""images/frame.CSS"" rel=""stylesheet"" type=""text/css"">"
				.Write "<body leftmargin=""0"" style=""overflow:hidden"" topmargin=""0"" marginwidth=""0"" marginheight=""0"" background="""">"
				.Write "<div id='foot'>"
