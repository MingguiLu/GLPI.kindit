...
Class Admin_UserGroup
       ...
       Sub Kesion()
		...
		Action=Trim(request("Action"))
			...
			response.Write "<div style=""height:30px;text-align:center"">KeSion CMS V 7.0, Copyright (c) 2006-2009 <a href=""http://www.kesion.com/"" target=""_blank""><font color=#ff6600>KeSion.Com</font></a>. All Rights Reserved . </div>"
		End Sub
...
<input type="text" name="SpaceSize" size="10" value="<%=SpaceSize%>" />KB <font color="#FF0000">提示：1 KB = 1024 Byte，1 MB = 1024 KB</font> </td>
			...
			<tr class="tdbg">
			  ...
			  <td height="30">
			    ...
			    <font color=#ff6600>一天内最多只能在同一类文档使用<input type='text' name='GroupSetting11' value="<%=GroupSetArr(11)%>" style='text-align:center;width:30px' />次  <font color='blue'>不限制请输入"0"</font>,此功能一般用于控制按有效期计费的会员权限,防止一次性恶意下载,查看全部收费信息，不是按有效期计费的用户组，建议设置成“0”。</font><br/>
			   ...
			   此会员组在允许刷新添加时间的模型里允许在<input type="text" name="GroupSetting12" size="5" value="<%=GroupSetArr(12)%>" style="text-align:center"/>分钟后重新刷新发布。不允许请输入"0"
			   </div>
              </td>
			</tr>			
