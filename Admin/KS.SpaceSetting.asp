...
Class Admin_System
		...
		With Response
			...
			.Write ".tips {color: #999999}" & vbCrLf
			.Write "-->" & vbCrLf
			.Write "</style>" & vbCrLf
			...
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td class=""clefttitle"" align=""right""><div><strong>是否启用二级域名：</strong></div></td>"
			.Write "      <td height=""30"">" 
			...
			.Write "     </td><td class=""tips"">此功能必须自己有独立服务器或是您的空间支持泛域名解释,若不支持请选择否</td>"
			.Write "    </tr>"
			 ...
			 .Write "    </td><td class=""tips"">关闭二级域名功能请留空,若设置为三级域名则用户站点访问形如:user.space.kesion.com,若设置二级域名则用户站点访问形如:user.kesion.com</td>"
			 .Write "</tr>"
			...
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 ...
			 .Write "     <td>"
				...
				End If
				.Write "允许上传的附件扩展名:<input type='text' value='" & Setting(27) & "' name='Setting(27)' /> 多个扩展名用 |隔开,如gif|jpg|rar等<Br/>允许上传的文件大小：<input name=""Setting(28)"" type=""text"" value=""" & Setting(28) &""" style=""text-align:center"" size='8'>KB<br/>每天上传文件个数：<input name=""Setting(29)"" type=""text"" value=""" & Setting(29) &""" style=""text-align:center"" size='8'>个,不限制请填0</font><br/>"
			 ...
			 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td height=""30"" class=""clefttitle"" align=""right""><div><strong>每个会员允许创建圈子个数：</strong></div></td>"
				.Write "  <td>"
			 ...
			 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td height=""30"" class=""clefttitle"" align=""right""><div><strong>副模板更多空间每页显示：</strong></div></td>"
			 .Write "  <td>"
			 .Write " <input type=""text"" name=""Setting(9)"" style=""text-align:center"" size=5 value=""" & Setting(9) & """> 个"
			 .Write "    </td><td class=""tips""></td>"
			 .Write "</tr>"
			 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td height=""30"" class=""clefttitle"" align=""right""><div><strong>副模板更多日志每页显示：</strong></div></td>"
			 .Write "  <td>"
			 .Write " <input type=""text"" name=""Setting(10)"" style=""text-align:center"" size=5 value=""" & Setting(10) & """> 篇"
			 .Write "    </td><td class=""tips""></td>"
			 .Write "</tr>"
			 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td height=""30"" class=""clefttitle"" align=""right""><div><strong>副模板更多圈子每页显示：</strong></div></td>"
			 .Write "  <td>"
			...
			.Write "      <td> <input name=""Setting(7)"" id='Setting7' type=""text"" value=""" & Setting(7) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting7')[0]") & "</td><td class=""tips"">对应页面/space/index.asp</td>"
			.Write "    </tr>"            
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""30"" class=""clefttitle"" align=""right""><div><strong>空间副模板：</strong></div></td>"
			.Write "      <td> <input name=""Setting(8)"" id='Setting8' type=""text"" value=""" & Setting(8) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting8')[0]") & "</td><td class=""tips"">空间的副模板，用于显示更多日志、相册、圈子等，必须包含标签“{$ShowMain}”。</td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""30"" class=""clefttitle"" align=""right""><div><strong>交友首页模板：</strong></div></td>"
			.Write "      <td> <input name=""Setting(23)"" id='Setting23' type=""text"" value=""" & Setting(23) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting23')[0]") & "</td><td class=""tips"">对应/space/friend/index.asp</td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""30"" class=""clefttitle"" align=""right""><div><strong>新鲜事列表模板：</strong></div></td>"
			.Write "      <td> <input name=""Setting(31)"" id='Setting31' type=""text"" value=""" & Setting(31) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting31')[0]") & "</td><td class=""tips"">对应/space/morefresh.asp </td>"
			.Write "    </tr>"
			 .Write " </table>"
			.Write " </div>"
