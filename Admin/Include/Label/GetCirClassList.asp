      ...
      function FieldInsertCode(fieldname,dbtype,dbname)
		...
		.echo "                <td width=""50%"" height=""20"">"
				...
				If LabelID = "" Or MenuBgType = "0" Then
				  ...
				  .echo " <img border=0 id=""ColorMenuBgShow"" src=""../../images/rect.gif"" style=""cursor:pointer;background-Color:" & MenuBg & ";"" onClick=""Getcolor(this,'../../../editor/ksplus/selectcolor.asp','ColorMenuBg');"" title=""选取颜色"">"
				  .echo ("</div>")
