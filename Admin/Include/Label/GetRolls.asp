...
Class GetRolls
		...
		.echo "            </tr>"
		  ...
		  .echo (" <img border=0 id=""PicBorderColorShow"" src=""../../images/rect.gif"" style=""cursor:pointer;background-Color:" & PicBorderColor & ";"" onClick=""Getcolor(this,'../../../editor/ksplus/selectcolor.asp','PicBorderColor');"" title=""选取颜色""> 可留空")
