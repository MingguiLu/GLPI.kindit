               ...
               <tr> 
				...
				<%Case 3%>
				 <div id="Content<%=SQL(6,K)%>" style="display:none">
					 ...
					 <%if F_B(8)=1 Then%>
					 <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>Editor/KSPlus/LabelParam.asp?action=DownPhoto',250,130);" class="LabelItem"><%=F_V(8)%></a></li>
					 <%end if%>
       ...
       <div onClick="ShowLabelTree('SearchLabel')" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
		 ...
		 <div onClick="ShowLabelTree('MusicLabel')" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
			  ...
			  <div id="MusicLabel" style="display:none">
                 <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>Editor/KSPlus/LabelParam.asp?action=GetMusicList',500,230);" class="LabelItem">取得歌曲播放列表(最新、推荐、热点-整站通用)</a></li>
				 <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>Editor/KSPlus/LabelParam.asp?action=GetSpecialList',500,250);" class="LabelItem">取得专辑列表(最新、推荐、热点-整站通用)</a></li>
