...
Class RefreshSpecial
		...
		.Write "<div style=""height:30px;text-align:center"">KeSion CMS V 7.0, Copyright (c) 2006-2010 <a href=http://www.kesion.com/ target=""_blank""><font color=#cc6600>KeSion.Com</font></a>. All Rights Reserved . </div>"
			.Write "</body>"
			.Write "</html>"
			End With
			End Sub
