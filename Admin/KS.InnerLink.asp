...
Class Inner_Main
	...
	%>
	   <script language="javascript">
		...
		function InnerAdd()
		{
			new KesionPopup().PopupCenterIframe('添加新站内链接','KS.InnerLink.asp?Action=Add',630,250,'no')
		}
		function EditInner(id)
		{
			new KesionPopup().PopupCenterIframe('添加新站内链接',"KS.InnerLink.asp?Action=Edit&Flag=Edit&InnerID="+id,630,250,'no')
		}
