...
Class Admin_Ask_Setting
		...
		With Response
			...
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 ...
			 .Write "   </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td height=""30"" class=""clefttitle""align=""right""><div><strong>模块名称：</strong></div></td>"
			 .Write "     <td height=""30""> "
			 ...
			 .Write "<div>扩展名<input type='text' name='Setting(17)' value='" & Setting(17) & "' size='10'>"
			 ...
			 .Write "     <td height=""30"" class=""clefttitle"" align=""right""><div><strong>问题描述/回答长度控制：</strong></div></td>"
			  ...
			  .Write "大于等于<input type=""text"" name=""Setting(4)"" size=""5"" value=""" & Setting(4) & """>小于等于<input type=""text"" name=""Setting(5)"" size=""5"" value=""" & Setting(5) & """> "
			 ...
			 .Write "  <td height=""30"">"
				...
				.Write "</tr>"
			 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>提问题是否需要审核：</strong></div></td>"
			 .Write "  <td height=""30"">"
				...
				.Write "   <span style='color:#999999'>--启用需要审核,则只有审核通过的问题才会及时显示</span></td>"
				.Write "</tr>"
			 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>允许上传附件：</strong></div></td>"
			 .Write "  <td height=""30"">"
			 ...
			 End If
			 .Write "<font color=green>允许上传的文件类型：<input name=""Setting(43)"" type=""text"" value=""" & Setting(43) &""" size='30'>多个类型用|线隔开<br/>允许上传的文件大小：<input name=""Setting(44)"" type=""text"" value=""" & Setting(44) &""" style=""text-align:center"" size='8'>KB<br/>每天上传文件个数：<input name=""Setting(45)"" type=""text"" value=""" & Setting(45) &""" style=""text-align:center"" size='8'>个,不限制请填0</font><br/><br/>"
			 ...
			 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>是否只能回答一次：</strong></div></td>"
				.Write "  <td height=""30"">"
				...
				.Write "</tr>"
			    .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			    .Write "     <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>是否允许游客提问题：</strong></div></td>"
				.Write "  <td height=""30"">"
			...
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 ...
			 .Write "     <span style='color:#999999'>设置成负数则表示提问题要消费</span></td>"
			 .Write "   </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
