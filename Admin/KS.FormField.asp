...
Class Admin_Field
		...
		Private FieldName,ID,Contact, Title, Tips, FieldType, DefaultValue, MustFillTF, ShowOnForm,ShowOnManage, ShowOnUserForm,Options,OrderID,FolderID,MaxFileSize,Width,Height,AllowFileExt,Step,ParentFieldName,ShowUnit,UnitOptions
		...
		.Write "<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>"
		 ...
		 If Optype = "Edit" Then
			 ...
			 End If
	  Else
	     FieldName="KS_":FieldType=1:MustFillTF=0:ShowOnForm=1:ShowOnManage=1:ShowOnUserForm=1:Width="200":Height="100":AllowFileExt="jpg|gif|doc":MaxFileSize=1024 : ShowUnit=0:OrderID=KS.ChkClng(Conn.Execute("Select max(orderid) From KS_FormField Where ItemID=" & itemID)(0))+1
