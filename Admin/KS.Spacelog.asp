...
<strong>快速查看：</strong>[<a href='?istalk=1'>新鲜事</a>] [<a href='?istalk=0'>博文</a>]
</div>
...
<tr height="22" class='list' onMouseOver="this.className='listmouseover'" onMouseOut="this.className='list'">
	...
	<td class="splittd">
	<%if rs("istalk")="1" then response.write "<span style='color:green'>[新鲜事]</span>" %>
	<a href="../space/?<%=rs("userid")%>/log/<%=rs("id")%>" target="_blank"><%=Rs("title")%></a><% if rs("best")="1" then response.write "<img src=""../images/jh.gif"" align=""absmiddle"">"%></td>
