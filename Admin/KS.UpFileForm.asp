	  ...
	  End Sub
		...
		Dim Path:Path = KS.GetUpFilesDir() & "/" 
			With KS
		     ...
		     .echo "          <label><input type=""checkbox"" name=""DefaultUrl"" value=""1"">生成缩略图删除原图</label>"
			 .echo "          <label><input name=""AddWaterFlag"" type=""checkbox"" id=""AddWaterFlag"" value=""1"" checked>"
			 .echo "加水印</label> <input type=""hidden"" name=""AutoReName"" value=""4""></td>"
			 .echo "      </span>"
			 .echo "    </form>"
		  End With
		End Sub
       ...
       With KS
        ...
        With KS
		 ...
		 .echo "          <input type=""file"" onchange=""doSubmit()""  size=""1"" name=""File1"" class='file'>"
		 .echo "         <input class=""button"" type=""button"" id=""BtnSubmit"" name=""Submit""  value=""选择本地图片..."">&nbsp;&nbsp;<span style=""color:red"">如果选择自动生成缩略图,则不开启图片裁剪窗口</span>"
		 .echo "          <input name=""Path"" value=""" & Path & """ type=""hidden"" id=""Path"">"
		 .echo "          <input name=""UpType"" value=""Pic"" type=""hidden"" id=""UpLoadFrom"">"
		...
		Sub Article_UpFile()
		  ...
		  With KS
			...
			.echo " <form name=""UpFileForm"" id=""UpFileForm"" method=""post"" enctype=""multipart/form-data"" action=""Include/UpFileSave.asp"">"
			.echo "   <span id=""uploadImg"">"
			.echo "   <input type=""file"" onchange=""doSubmit()"" size=""1"" name=""File1"" class='file'><input type=""button"" id=""BtnSubmit"" name=""Submit"" class=""button"" value=""选择本地附件并上传..."">"
			.echo "                  <input type=""hidden"" name=""AutoReName"" value=""4"">"
			.echo "          <input name=""Path"" value=""" & Path & """ type=""hidden"" id=""Path"">"
		...
		Dim Path:Path = KS.GetUpFilesDir() & "/" 
			With KS
			 ...
			 .echo "      <span id=""uploadImg"">"
			 .echo "          <input type=""file"" onchange=""doSubmit()"" size=""1"" name=""File1"" class='file'>"
			 .echo "          <input type=""button"" id=""BtnSubmit"" name=""Submit"" class=""button"" value=""选择本地图片并上传..."" >&nbsp;&nbsp;<span style=""color:red"">如果选择自动生成缩略图,则不开启图片裁剪窗口</span>"
			 .echo "          <input name=""Path"" value=""" & Path & """ type=""hidden"" id=""Path"">"
			 .echo "          <input name=""UpType"" value=""Pic"" type=""hidden"" id=""UpLoadFrom"">"
			 .echo "          <input name=""BasicType"" value=""" & BasicType & """ type=""hidden"">"
			 .echo "          <input name=""ChannelID"" value=""" & ChannelID & """ type=""hidden"">"		
			 .echo "          <input type=""hidden"" name=""AutoReName"" value=""4"">"
			 .echo "          <label><input type=""checkbox"" name=""DefaultUrl"" value=""1"">生成缩略图</label>"
			 .echo "          <label><input name=""AddWaterFlag"" type=""checkbox"" id=""AddWaterFlag"" value=""1"" checked>"
			 .echo "加水印</label></span>"
			 .echo "    </form>"
			End With
		...
		Sub Down_UpFile()
		  ...
		  With KS
			 ...
			 .echo "         <input type=""button"" id=""BtnSubmit"" name=""Submit"" class=""button"" value=""选择本地文件并上传..."" >"
			 .echo "          <input name=""BasicType"" value=""" & BasicType & """ type=""hidden"">"
			 .echo "          <input name=""ChannelID"" value=""" & ChannelID & """ type=""hidden"">"		
			 .echo "                  <input name=""Path"" value=""" & Path & """ type=""hidden"" id=""Path"">"
		...
		Sub Shop_UpPhoto()
			...
			With KS
			 ...
			 .echo "   <input type=""button"" id=""BtnSubmit"" name=""Submit"" class=""button"" value=""选择本地图片并上传..."" >"
			 .echo "   <span style=""color:red"">如果选择自动生成缩略图,则不开启图片裁剪窗口</span><input name=""Path"" value=""" & Path & """ type=""hidden"" id=""Path"">"
			 .echo "   <input name=""UpType"" value=""Pic"" type=""hidden"" id=""UpLoadFrom"">"
			 .echo "   <input name=""BasicType"" value=""" & BasicType & """ type=""hidden"">"
			 .echo "   <input name=""ChannelID"" value=""" & ChannelID & """ type=""hidden"">"		
			 .echo "   <input type=""hidden"" name=""AutoReName"" value=""4"">"
			 .echo "   <label><input type=""checkbox"" name=""DefaultUrl"" value=""1"">同时生成缩略图</label>"
			 .echo "   <label><input name=""AddWaterFlag"" type=""checkbox"" id=""AddWaterFlag"" value=""1"" checked>"
			 .echo "添加水印</label></span>"
			 .echo "</form>"
		  End With
		End Sub
		...
		Sub Movie_UpFile()
		  ...
		  With KS
			 ...
			 .echo "   <span id=""uploadImg"">"
			 .echo "   <input type=""file"" accept=""html"" onchange=""doSubmit()"" size=""1"" name=""File1"" class='file'>"
			 .echo "   <input type=""button"" id=""BtnSubmit"" name=""Submit"" class=""button"" value=""选择本地影片并上传..."">"
			 .echo "   <input name=""BasicType"" value=""" & BasicType & """ type=""hidden"">"
			 .echo "   <input name=""ChannelID"" value=""" & ChannelID & """ type=""hidden"">"		
			 .echo "   <input name=""Path"" value=""" & Path & """ type=""hidden"" id=""Path"">"
        ...
        With KS
		 ...
		 .echo "  <span id=""uploadImg"">"
		 .echo "   <input type=""file"" accept=""html"" size=""1"" onchange=""doSubmit()"" name=""File1"" class='file'>"
		 .echo "<span style=""color:red""><input type=""button"" id=""BtnSubmit"" name=""Submit"" class=""button"" value=""选择本地图片并上传..."">如果选择自动生成缩略图,则不开启图片裁剪窗口</span>"
		 .echo "          <input name=""Path"" value=""" & Path & """ type=""hidden"" id=""Path"">"
		 .echo "          <input name=""UpType"" value=""Pic"" type=""hidden"" id=""UpLoadFrom"">"
		 .echo "          <input name=""BasicType"" value=""" & BasicType & """ type=""hidden"">"
		 .echo "          <input name=""ChannelID"" value=""" & ChannelID & """ type=""hidden"">"		
		 ...
		 .echo "          <label><input type=""checkbox"" name=""DefaultUrl"" value=""1"">"
		 .echo "          生成缩略图</label>"
		 .echo "     <label><input name=""AddWaterFlag"" type=""checkbox"" id=""AddWaterFlag"" value=""1"" checked>添加水印</albel></span>"
		 .echo "    </form>"
		 End With
		End Sub
		'试券图片
		...
		Dim Path:Path = KS.GetUpFilesDir() & "/sj/"
		 ...
		 .echo "   <span id=""uploadImg"">"
		 .echo "          <input type=""file"" onchange=""doSubmit()"" size=""1"" name=""File1"" class='file'>"
		 .echo " <input type=""button"" style=""margin-top:5px"" id=""BtnSubmit"" name=""Submit"" class=""button"" value=""选择本地文件并上传..."">"
		 .echo "          <input name=""Path"" value=""" & Path & """ type=""hidden"" id=""Path"">"
		 .echo "          <input name=""UpType"" value=""Pic"" type=""hidden"" id=""UpLoadFrom"">"
		 .echo "          <input name=""BasicType"" value=""" & BasicType & """ type=""hidden"">"
		 .echo "          <input name=""ChannelID"" value=""" & ChannelID & """ type=""hidden"">"		
