		  ...
		  With KS
			...
			$(document).ready(function(){
				...
				{   if (SpecialID=='') SpecialID=get_Ids(document.myform);
					if (SpecialID!='')
					{
					   new KesionPopup().PopupCenterIframe('发布专题','include/RefreshspecialSave.asp?Types=Special&id='+SpecialID+'&RefreshFlag=ID',530,110,'no')
					}
					else 
					alert('请选择要发布的专题!');
				}
				...
				{ if (SpecialID=='') SpecialID=get_Ids(document.myform);
					 if (SpecialID!=''){
						 ...
						 new KesionPopup().PopupCenterIframe('查看专题<font color=red>['+SpecialName+']</font>下的文档','?Action=ShowInfo&SpecialID='+SpecialID+'',750,430,'auto')
