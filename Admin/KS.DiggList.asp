...
%>	   		
     <SCRIPT language=javascript>
		...
		function show(t,m,d)
		{
		new KesionPopup().PopupCenterIframe('查看详情[<font color=red>'+t+'</font>]记录','KS.DiggList.asp?action=list&infoid='+d+'&ChannelID='+m,750,440,'auto')
		}
		function ShowCode(){
		new KesionPopup().PopupCenterIframe('查看Digg调用代码','KS.DiggList.asp?action=ShowCode',750,440,'no')
		}
