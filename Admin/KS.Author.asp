...
Class Admin_Author
	...
	%>
	   <script language="javascript">
		...
		function AuthorAdd()
		{
		 new KesionPopup().PopupCenterIframe('新增作者/开发商','KS.Author.asp?ChannelID='+ChannelID+'&Action=Add',630,410,'no')
		}
		function EditAuthor(id)
		{
		  new KesionPopup().PopupCenterIframe('编辑作者','KS.Author.asp?ChannelID='+ChannelID+'&Action=Edit&ID='+id,630,410,'no')
		}
