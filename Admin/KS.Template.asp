...
Class Template
		...
		{
		  OpenWindow('KS.Frame.asp?Action=AddTemplateFile&PageTitle='+escape('添加新的模板文件')+'&URL=KS.Template.asp&currpath='+escape(CurrPath),350,100,window);
		 location.reload();
		}
		function UpFile()
		{
		 OpenWindow('KS.Frame.asp?PageTitle='+escape('上传文件')+'&Url=KS.Template.asp&action=Upfile&Path='+escape(CurrPath),400,200,window);
		 location.href='?CurrPath='+escape(CurrPath);
		}
	  ...
	  Sub AddTemplate()
        ...
        Response.Write "</table>"
		 ...
		 Response.Write "     <td height=""30"" style='text-align:left'><b>模板地址：</b><input name=""TemplateFileName"" type=""text"" id=""TemplateFileName"" size=""50"" Value=""" & TemplateFileName & """ readonly>"
...
%>
		 ...
		 %>
		 	...
		 	<textarea name="Content" rows="2" cols="30" id="Content" onscroll="show_ln('txt_ln','Content')" onKeyDown="editTab()" style="height:422px;width:770;"><%=Server.HTMLEncode(TemplateFromFileContent)%></textarea>  
	  ...
	  Sub TemplateSave()
	   ...
	   Sub UpFile()
		...
		Response.Write "<link rel=""stylesheet"" href=""../editor/ksplus/Editor.css"">"
