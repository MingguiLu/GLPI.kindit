...
Class Admin_Origin
		...
		function OriginAdd()
		{
		  new KesionPopup().PopupCenterIframe('新增来源','KS.Origin.asp?Action=Add',630,410,'no')
		}
		function EditOrigin(id)
		{ 
		new KesionPopup().PopupCenterIframe('编辑来源',"KS.Origin.asp?action=Edit&ID="+id,630,410,'no')
		}
