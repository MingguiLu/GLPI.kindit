...
<script src="../KS_Inc/Kesion.box.js"></script>
			<script language="javascript">
				...
				function AreaAdd()
				{
						 new KesionPopup().PopupCenterIframe('新增地区','?Action=add&parentid=<%=ks.s("parentid")%>',630,200,'no')
				}
				function EditArea(id)
				{
					 new KesionPopup().PopupCenterIframe('编辑地区','KS.Province.asp?Action=add&ID='+id,630,200,'no')
				}
				function DelArea(id)
				{
