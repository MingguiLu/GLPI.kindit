...
Class Admin_System
		...
		With Response
			...
			If KS.G("Flag") = "Edit" Then
				...
				Next
			     ...
			     if instr(Request.Form("Setting(90)"),".")<>0 or instr(Request.Form("Setting(91)"),".")<>0 or instr(Request.Form("Setting(92)"),".")<>0 or instr(Request.Form("Setting(93)"),".")<>0 or instr(Request.Form("Setting(94)"),".")<>0 or instr(Request.Form("Setting(95)"),".")<>0 or instr(Request.Form("Setting(96)"),".")<>0 then
			...
			.Write "      <td> <input name=""Setting(0)"" type=""text"" id=""Setting(0)"" value=""" & Setting(0) & """ size=""40"" class=""txt""></td><td class='tips'>可以在模板里通过{$GetSiteName}标签调用</td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			 .Write "     <td height=""30"" class=""clefttitle"" align=""right""><div><strong>网站标题：</strong></div></td>"
			 .Write "     <td> <input name=""Setting(1)"" type=""text"" id=""Setting(1)"" value=""" & Setting(1) & """ size=""40"" class=""txt""></td><td class='tips'>可以在模板里通过{$GetSiteTitle}标签调用</td>"
			 .Write "   </tr>"
			 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			  .Write "    <td height=""30"" class=""clefttitle""> <div align='right'><strong>网站地址：</strong></div></td>"
			 .Write "    <td> <input name=""Setting(2)"" type=""text""  value=""" &KS.GetAutoDomain & """ size=""40"" class=""txt"">"
			 ...
			 .Write "     <td> <input name=""Setting(3)"" type=""text"" id=""Setting(3)""  value=""" & InstallDir & """ readonly size=""40"" class=""txt"">"
			 ...
			 .Write "     <td height=""30"" class=""clefttitle"" align=""right""><div><strong>网站Logo地址：</strong></div></td>"
			  .Write "    <td><input name=""Setting(4)"" type=""text"" id=""Setting(4)""   value=""" & Setting(4) & """ size=""40"" class=""txt"">"
			 ...
			 .Write "     <td height=""30"" class=""clefttitle"" align=""right""><div><strong>生成的网站首页：</strong></div></td>"
			   ...
			   .Write "    </tr>"
				...
				.Write "  <td><input name=""Setting(6)"" onBlur=""CheckNumber(this,'允许上传最大文件大小');"" type=""text"" id=""Setting(6)""   value=""" & Setting(6) & """ size=10 class='txt' style='text-align:center'>"
			...
			.Write "      <td><input name=""Setting(7)"" type=""text"" id=""Setting(7)""   value=""" & Setting(7) & """ size='40' class='txt'></td><td class='tips'> 多个类型用|线隔开</td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""30"" class=""clefttitle""><div align=""right""><strong>删除不活动用户时间：</strong></div></td>"
			.Write "      <td><input name=""Setting(8)"" type=""text""  value=""" &  Setting(8) & """ style=""text-align:center"" size=""8"" class=""txt""> 分钟  </td><td class='tips'>如果在这个时间内用户没有活动,则用户的在线状态将被置为离线,值越小越精确,但消耗资源越大,建议设置在5-30分钟之间。</td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""30"" class=""clefttitle""><div align=""right""><strong>文章自动分页每页大约字符数：</strong></div></td>"
			.Write "      <td><input name=""Setting(9)"" type=""text"" value=""" & Setting(9) & """ style=""text-align:center"" size=""8"" class=""txt""> 个字符</td><td class='tips'>如果不想自动分页，请输入""0""</td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""30"" class=""clefttitle"" align=""right""><div><strong>站长姓名：</strong></div></td>"
			.Write "      <td> <input name=""Setting(10)"" type=""text""   value=""" & Setting(10) & """ size=""40"" class=""txt""></td><td class='tips'>可在模板里使用{$GetWebMaster}调用</td>"
			.Write "    </tr>"
			...
			.Write "      <td height=""21"" align=""right"" class=""clefttitle""><div><strong>要屏蔽的关键字：</strong></div></td>"
			 ...
			 .Write "     <td height=""30""> <input name=""Setting(15)"" type=""text""  value=""" & Setting(15) & """ size=40 class='txt'>"
			 ...
			 .Write "     <td height=""30""> <input name=""Setting(17)"" type=""text""  value=""" & Setting(17) & """ size=40 class='txt'>"
			...
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>留言/论坛首页模板：</strong></div></td>"
			...
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>论坛版面列表页模板：</strong></div></td>"
			.Write "      <td width=""63%"" height=""30""> <input name=""Setting(172)"" id=""Setting172"" type=""text"" value=""" & Setting(172) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting172')[0]") & " <a href='../club/index.asp' target='_blank' style='color:green'>页面:/club/index.asp</a></td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>论坛帖子页模板：</strong></div></td>"
			.Write "      <td width=""63%"" height=""30""> <input name=""Setting(160)"" id=""Setting160"" type=""text"" value=""" & Setting(160) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting160')[0]") & " <a href='../club/display.asp' target='_blank' style='color:green'>页面:/club/display.asp</a></td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>留言/论坛签写页面模板：</strong></div></td>"
			...
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>论坛搜索模板：</strong></div></td>"
			.Write "      <td width=""63%"" height=""30""> <input name=""Setting(171)"" id=""Setting171"" type=""text"" value=""" & Setting(171) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting171')[0]") & " <a href='../club/query.asp' target='_blank' style='color:green'>页面:/club/query.asp</a></td>"
			.Write "    </tr>"
			...
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>会员注册表单模板：</strong></div></td>"
			.Write "      <td width=""63%"" height=""30""> <input name=""Setting(117)"" id=""Setting117"" type=""text"" value=""" & Setting(117) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting117')[0]") & " <a href='../?do=reg' target='_blank' style='color:green'>页面:/?do=reg</a></td>"
			.Write "    </tr>"
			...
			.Write "    <tr" & dis &" valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""30"" class=""clefttitle"" align=""right""><div><strong>游客订单查询模板：</strong></div></td>"
			.Write "      <td width=""63%"" height=""30""> <input name=""Setting(173)"" id=""Setting173"" type=""text"" value=""" & Setting(173) & """ size=""30"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting173')[0]") & " <a href='../shop/myorder.asp' target='_blank' style='color:green'>页面:/shop/myorder.asp</a></td>"
			.Write "    </tr>"
			...
			.Write "    <td class='tips'>可以设置多个,一行一个验证选项,尽量多填一些选项，更能有效防注册机的干扰。</td></tr>"
            .Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
		...
		.Write "		</SCRIPT>"
			...
			.Write "  <table width=""100%"" border=""0"" align=""center"" cellpadding=""1"" cellspacing=""1"" class=""ctable"">"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width='200' height=""21"" class=""clefttitle"" align=""right""><div><strong>是否允许新会员注册：</strong></div></td>"
			...
			.Write "      <td><textarea name=""Setting(23)"" cols=""65"" rows=""7"">" & Setting(23) & "</textarea>"
			...
			.Write "      <td> <label><input name=""Setting(32)"" type=""radio"" value=""1"""
			 ...
			 .Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=220 height=""21"" class='clefttitle' align=""right""><div><strong>注册成功发邮件通知：</strong></div></td>"
			...
			.Write "      <td> <input name=""Setting(148)"" type=""radio"" value=""1"""
			 ...
			 .Write "</tr>"			 
			 .Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""21"" class='clefttitle' align=""right""><div><strong>新注册手机号码必填：</strong></div></td>"
			.Write "      <td height=""21""> <input name=""Setting(149)"" type=""radio"" value=""1"""
			 ...
			 .Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""21"" class='clefttitle' align=""right""><strong>新注册启用IP限制：</strong></td>"
			.Write "      <td height=""21""> <input name=""Setting(26)"" type=""radio"" value=""1"""
			 ...
			 .Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" class='clefttitle' align=""right""><strong>新注册启用验证码：</strong></td>"
			.Write "      <td> <input name=""Setting(27)"" type=""radio"" value=""1"""
			...
			.Write "      <td> 最少字符数<input name=""Setting(29)"" type=""text"" onBlur=""CheckNumber(this,'用户名最小字符数');"" size=""3"" value=""" & Setting(29) & """>个字符  最多字符数<input name=""Setting(30)"" type=""text"" onBlur=""CheckNumber(this,'用户名最多字符数');"" size=""3"" value=""" & Setting(30)& """>个字符"
			.Write "       </td><td class='tips'></td>" 
	        .Write "</tr>"
			.Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			...
			.Write "</tr>" 
			 ...
			 .Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" class='clefttitle' align=""right""><div><strong>会员登录启用验证码：</strong></div></td>"
			.Write "      <td> <input name=""Setting(34)"" type=""radio"" value=""1"""
			 If Setting(34)="1" Then .Write " Checked"
			 .Write ">是"
			 .Write "&nbsp;&nbsp;<input name=""Setting(34)"" type=""radio"" value=""0"""
			 If Setting(34)="0" Then .Write " Checked"
			 .Write ">否"
			 .Write "</td><td class='tips'>启用验证码功能可以在一定程度上防止会员密码被暴力破解</td>"
			 .Write "</tr>"
			 .Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			...
			.Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" class='clefttitle' align=""right""><div><strong>新注册时赠送的资金</strong>：</div></td>"
			.Write "      <td> <input class='txt' style='text-align:center' onBlur=""CheckNumber(this,'新会员注册时赠送的金钱');"" name=""Setting(38)"" type=""text"" size=""5"" value=""" & Setting(38) & """>"
			.Write "元人民币</td><td class='tips'>为0时不赠送,此资金可用于商城中心购物</td>"
			.Write "</tr>"
			.Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" class='clefttitle' align=""right""><div><strong>新注册时赠送的积分：</strong></div></td>"
			.Write "      <td> <input class='txt' style='text-align:center' name=""Setting(39)"" onBlur=""CheckNumber(this,'新会员注册时赠送的积分');"" type=""text"" size=""5"" value=""" & Setting(39) & """>"
			.Write "分积分</td><td class='tips'></td>"
	        .Write "</tr>"
			.Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" class='clefttitle' align=""right""><div><strong>新注册时赠送的点券：</strong></div></td>"
			.Write "      <td> <input class='txt' style='text-align:center' onBlur=""CheckNumber(this,'新会员注册时赠送的点券');"" name=""Setting(40)"" type=""text"" size=""5"" value=""" & Setting(40) & """>"
			.Write "点点券（为0时不赠送）<br/></td><td class='tips'>如果用户组选择了扣点用户,并设置了默认点数,则以用户组里的设置为准</td>"
			.Write "</tr>"
			.Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" class='clefttitle' align=""right""><div><strong>积分与点券兑换比率：</strong> </div></td>"
			.Write "      <td> <input class='txt' style='text-align:center' onBlur=""CheckNumber(this,'会员的积分与点券的兑换比率');"" name=""Setting(41)"" type=""text"" size=""5"" value=""" & Setting(41) & """>"
			...
			.Write "      <td> <input class='txt' style='text-align:center' onBlur=""CheckNumber(this,'会员的积分与有效期的兑换比率');"" name=""Setting(42)"" type=""text"" size=""5"" value=""" & Setting(42) & """>"
			...
			.Write "      <td> <input class='txt' style='text-align:center' onBlur=""CheckNumber(this,'会员的资金与点券的兑换比率');"" name=""Setting(43)"" type=""text"" size=""5"" value=""" & Setting(43) & """>"
			...
			.Write "      <td> <input class='txt' style='text-align:center' onBlur=""CheckNumber(this,'会员的资金与有效期的兑换比率');"" name=""Setting(44)"" type=""text"" size=""5"" value=""" & Setting(44) & """>"
			...
			.Write "      <td> 名称<input class='txt' style='text-align:center' name=""Setting(45)"" type=""text"" size=""5"" value=""" & Setting(45) & """><font color=red>例如：科汛币、点券、金币</font>  单位<input class='txt' style='text-align:center' name=""Setting(46)"" type=""text"" size=""5"" value=""" & Setting(46) & """> <font color=red>例如：点、个</font>"
			.Write "</td><td class='tips'></td>"
			.Write "</tr>"

			.Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""21""  class='clefttitle' align=""right""><div><strong>会员站内短信设置：</strong></div></td>"
			.Write "      <td height=""21""> 最大容量为<input class='txt' style='text-align:center' onBlur=""CheckNumber(this,'请填写有效条数!');"" name=""Setting(47)"" type=""text"" size=""5"" value=""" & Setting(47) & """>条,短信内容最多字符数<input onBlur=""CheckNumber(this,'短信内容最多字符数');"" class='txt' style='text-align:center' name=""Setting(48)"" type=""text"" size=""5"" value=""" & Setting(48) & """>个字符 群发限制人数<input onBlur=""CheckNumber(this,'群发限制人数');"" class='txt' style='text-align:center' name=""Setting(49)"" type=""text"" size=""5"" value=""" & Setting(49) & """>人"
			.Write "</td><td class='tips'></td>"	
			.Write "</tr>"		
			.Write "    <tr style='display:none' valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			...
			.Write " <input name=""Setting(143)"" type=""radio"" value=""1"""
			 ...
			 .Write ">否<br>"
			.Write "会员推广赠送积分：<input onBlur=""CheckNumber(this,'会员推广赠送积分');"" name=""Setting(144)"" type=""text"" size=""5"" value=""" & Setting(144) & """ class='txt' style='text-align:center'> 分 <font color=green>成功推广一个用户注册得到的积分</font><br>推广文字：<textarea name=""Setting(145)"" cols=""50"" rows=""2"">" & Setting(145) & "</textarea><br><font color=red>推广链接：" & KS.GetDomain & "?do=reg&Uid=用户名</font></FIELDSET>"
			...
			.Write " <input name=""Setting(166)"" type=""radio"" value=""1"""
			 ...
			 .Write ">否<br>"
			.Write "点一个广告赠送积分：<input onBlur=""CheckNumber(this,'点广告赠送积分');"" name=""Setting(167)"" type=""text"" size=""5"" value=""" & Setting(167) & """ class='txt' style='text-align:center'> 分 <font color=green>一天内点击同一个广告只计一次积分</font><br/><font color=blue>tips:广告系统用纯文字或图片类广告此处的设置才有效</font></FIELDSET>"
			...
			.Write " <input name=""Setting(168)"" type=""radio"" value=""1"""
			 ...
			 .Write ">否<br>"
			.Write "点一个友情链接赠送积分：<input onBlur=""CheckNumber(this,'点友情链接赠送积分');"" name=""Setting(169)"" type=""text"" size=""5"" value=""" & Setting(169) & """ class='txt' style='text-align:center'> 分 <font color=green>一天内点击同一个友情链接只计一次积分</font></FIELDSET>"
			...
			.Write "<tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""21"" class='clefttitle' align=""right""><div><strong>积分/资金互换设置</strong></div></td>"
			.Write "      <td height=""21""> "
			...
			.Write "      <td> <input name=""Setting(11)"" class='txt' type=""text""  value=""" & Setting(11) & """ size=40></td><td class='tips'></td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""30"" class=""clefttitle"" align='right'><strong>SMTP服务器地址:</strong></td>"
			.Write "     </td>"
			.Write "      <td><input name=""Setting(12)"" type=""text"" value=""" & Setting(12) & """ size=40  class='txt'></td><td class='tips'>用来发送邮件的SMTP服务器如果你不清楚此参数含义，请联系你的空间商</td>"
			.Write "    </tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""30"" class=""clefttitle"" align='right'><strong>SMTP登录用户名:</strong></td>"
			.Write "      <td><input name=""Setting(13)"" type=""text"" value=""" & Setting(13) & """ size=40  class='txt'></td>"
			...
			.Write "      <td><input name=""Setting(14)"" type=""password"" value=""" &Setting(14) & """ size=40  class='txt'></td>"
			.Write "    <td class='tips'>当你的服务器需要SMTP身份验证时还需设置此参数</td></tr>"
			.Write "</table>"	
			.Write "</div>"
						                                                      '=====================================================留言系统参数配置开始=========================================
			...
			.Write "      <td> <label><input onclick=""$('#bbs').show()"" name=""Setting(56)"" type=""radio"" value=""1"""
			 ...
			 End If
			 .Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" align=""right"" class=""clefttitle""><div><strong>运行模式：</strong></div></td>"
			...
			.Write "      <td><input name=""Setting(66)"" type=""text"" class='txt' value=""" & Setting(66) & """ size=""10"">"
			...
			.Write "      <td><input name=""Setting(69)"" type=""text"" class='txt' value=""" & Setting(69) & """ size=""15"">"
			.Write "</td><td class='tips'>如:bbs.kesion.com,www.kesion.cn等,不要带""http://"",如果不绑定请留空,否则可以导致页面路径出错,支持独立域名或二级域名的绑定</td></tr>"
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			...
			.Write "      <td><input name=""Setting(61)"" type=""text""  value=""" & Setting(61) & """ size=""40"" class='txt'> "
			...
			.Write "      <td><input name=""Setting(62)"" class='txt' type=""text""  value=""" & Setting(62) & """ size=""10""> "
			 .Write "</td><td class='tips'>如:帖子,留言等</td></tr>"
			 
			 .Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""24"" align=""right"" class=""clefttitle""><strong>留言/发帖是否需要登录：</strong></td>"
			...
			.Write "    <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td  height=""21"" align=""right"" class=""clefttitle""><strong>留言列表显示信息数：</strong></td>"
			.Write "      <td><input name=""Setting(51)"" class='txt' style='text-align:center' type=""text"" id=""WebTitle"" value=""" & Setting(51) & """ size=""10""> 条"
			 .Write "</td><td class='tips'>在留言查看页面中，每一页留言列表默认显示的信息条数。</td></tr>"
			
			.Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" align=""right"" class=""clefttitle""><div><strong>审核设置：</strong></div></td>"
			.Write "      <td> <label><input name=""Setting(52)"" type=""checkbox"" value=""1"""
			If Setting(52)="1" Then .Write " checked"
			.Write "/>发表主题需要审核</label>"
			 
			 .write "<label><input  name=""Setting(60)"" type=""checkbox"" value=""1"""
			 If Setting(60)="1" Then .Write " Checked"
			.Write "/>回帖需要审核</label>"
			 .Write "</td><td class='tips'>指当访问者发布新的留言是否需要审核，如果需要审核，发布的留言必须经过审核才能在前台显示。</td></tr>"
			.Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			...
			.Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td height=""21"" align=""right"" class=""clefttitle""><div><strong>留言/发帖需要输入验证码：</strong></div></td>"
			...
			.Write "      <td height=""21""> <input  name=""Setting(54)"" type=""radio"" value=""1"""
			 ...
			 .Write "</td><td class='tips'>如果各个版面启用用户组限制,则与版面设置为准</td></tr>"
			...
			.Write "      <td height=""21"" align=""right"" class=""clefttitle""><div><strong>上传附件存放目录：</strong></div></td>"
			 .Write "    <td><input class='txt' name=""Setting(67)"" type=""text"" value=""" & Setting(67) &""" size='40'> "
			...
			.Write "      <td height=""21""> <input name=""Setting(65)"" style=""text-align:center"" size=""6"" value=""" & Setting(65) & """>%"
			 .Write "</td></tr>"
			.Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""21"" class=""clefttitle"" align=""right""><div><strong>美元汇率：</strong></td>"
			.Write "      <td height=""21""> <input name=""Setting(81)"" style=""text-align:center"" size=""6"" value=""" & Setting(81) & """>  <font color=#ff6600>如:1美元=6.7784人民币元 则这里填6.7784</font> <br/>当启用paypal国际版支付平台时，系统将根据此汇率将人民币转换为美元进行支付"
			 .Write "</td></tr>"
			...
			.Write "<font color=red>不加前缀请留空</font></td></tr>"
			
			.Write "    <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "      <td width=""32%"" height=""21"" class=""clefttitle"" align=""right""><div><strong>购商品最少支付定金：</strong></div></td>"
			.Write "      <td height=""21""> <input name=""Setting(82)"" size=""6"" value=""" & Setting(82) & """> 元"
			.Write " <font color=red>如果本商城购物只能付全款，请输入“0”,否则这里输入最少要支付的定金。</font></td></tr>"
			...
			.Write " <img border=0 id=""MarkFontColorShow"" src=""images/rect.gif"" style=""cursor:pointer;background-Color:" & TBSetting(10) & ";"" onClick=""Getcolor(this,'../editor/ksplus/selectcolor.asp','TBSetting(10)');"" title=""选取颜色""></td>"
			.Write "          </tr>"
			.Write "          <tr  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			...
			.Write " <img border=0 id=""MarkTranspColorShow"" src=""images/rect.gif"" style=""cursor:pointer;background-Color:" & TBSetting(15) & ";"" onClick=""Getcolor(this,'../editor/ksplus/selectcolor.asp','TBSetting(15)');"" title=""选取颜色"">"
			...
			.Write "      <td height=""21""> 后台管理目录：<input class='txt' name=""Setting(89)"" type=""text"" value=""" & Setting(89) & """ size=30><br>模板文件目录：<input class='txt' name=""Setting(90)"" type=""text"" value=""" & Setting(90) & """>后面必须带&quot;/&quot;符号"
			.Write "<br>默认上传目录：<input class='txt' name=""Setting(91)"" type=""text"" value=""UploadFiles/"" readonly><font color=green>新版(V6.0及以后的版)统一命名为UploadFiles目录下</font>"
			.Write "<br>远程存图目录：<input class='txt' name=""Setting(92)"" type=""text"" value=""" & Setting(92) & """>后面必须带&quot;/&quot;符号"
			.Write "<br>生成 JS 目录：<input class='txt' name=""Setting(93)"" type=""text"" value=""" & Setting(93) & """>后面必须带&quot;/&quot;符号"
			.Write "<br>通用页面目录：<input class='txt' name=""Setting(94)"" type=""text"" value=""" & Setting(94) & """>后面必须带&quot;/&quot;符号"
			.Write "<br>网站专题目录：<input class='txt' name=""Setting(95)"" type=""text"" value=""" & Setting(95) & """>后面必须带&quot;/&quot;符号"
			.Write "</td>"
            .Write "</tr>"
		    .Write "     <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "       <td width=""32%"" height=""30""align=""right"" class='clefttitle'><div><strong>存放目录区别管理员：</strong></div>若选择<font color=red>""是""</font>系统将按 ""总上传目录/2010-5/管理员名称"" 的格式保存上传文件。</td>"
			...
			.Write "     </tr>"
		    .Write "     <tr valign=""middle""  class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "       <td width=""32%"" height=""30""align=""right"" class='clefttitle'><div><strong>远程保存的图片加水印：</strong></div>若选择<font color=red>""是""</font>涉及到远程存图的地方将自动加水印,如采集或是文章里的自动存图等。</td>"
			...
			.Write "       <td width=""32%"" height=""25"" class=""clefttitle"" align=""right""> <div><strong>百度电子地图密钥：</strong></div>"
			.Write "         </div></td>"
			.Write "       <td height=""21"" valign=""middle""> <input class='txt' name=""Setting(175)"" type=""text"" value=""" & Setting(175) & """ size=""20""> 按以下地址<a href='http://openapi.baidu.com/map/signup.html' target='_blank'>http://openapi.baidu.com/map/signup.html</a>申请  </td>"
			.Write "</tr>"
			.Write "     <tr class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "       <td width=""32%"" height=""25"" class=""clefttitle"" align=""right""> <div><strong>地图默认经纬坐标：</strong></div>"
			.Write "         </div></td>"
			.Write "       <td height=""21"" valign=""middle""> <input class='txt' id=""mapcenter"" name=""Setting(176)"" type=""text"" value=""" & Setting(176) & """ size=""20"">  电子地图默认显示的中心坐标 <input  type='button' value='获取中心坐标' class='button' onclick='addMap()'/><br/>当商家没有标注时将默认显示这里设置的中心坐标位置。"
			%>
		   <script src='../ks_inc/kesion.box.js'></script>
			<script>
		  function addMap(){
			  new KesionPopup().PopupCenterIframe('获取中心坐标','../plus/baidumap.asp?action=getcenter&MapMark='+escape($("#MapMark").val()),730,450,'auto');
		  }
		  </script>
			<%
			.Write " </td>"
			.Write "</tr>"
	        .Write "     <tr class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			.Write "       <td width=""32%"" height=""25"" class=""clefttitle"" align=""right""> <strong>电子地图调用方法：</strong>"
			.Write "  <br/>请在右边代码复制放到您需要用到电子地图的内容页即可。</td>"
...
<!--电子地图结束--->
			...
			.Write "         </div></td>"
			.Write "       <td height=""21"" valign=""middle""> <input class='txt' name=""Setting(99)"" type=""text"" value=""" & Setting(99) & """ size=""50"">      </td>"
			.Write "</tr>"
		...
		.write "</tbody>"
			...
			.Write "<div style=""height:30px;text-align:center"">KeSion CMS V 7.0, Copyright (c) 2006-2010 <a href=""http://www.kesion.com/"" target=""_blank""><font color=#ff6600>KeSion.Com</font></a>. All Rights Reserved . </div>"
		...
		Response.Write "<div style=""height:30px;text-align:center"">KeSion CMS V 7.0, Copyright (c) 2006-2010 <a href=http://www.kesion.com/ target=""_blank""><font color=#cc6600>KeSion.Com</font></a>. All Rights Reserved . </div>"
		        Response.Write ("</div>")
				Response.Write ("</body>")
				Response.Write ("</html>")
		End Sub
