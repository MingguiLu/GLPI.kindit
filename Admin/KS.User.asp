...
Class Admin_User
       ...
       Sub Kesion()
			...
			Response.Write "<div id='mtl'>快速查找用户：</div><li><a href=""KS.User.asp?Action=Search"">搜索用户</a></li>&nbsp;|&nbsp;<a href=""?UserSearch=12"">所有用户</a>&nbsp;|&nbsp;<a href=""?UserSearch=13"" style='color:red'>在线用户</a>&nbsp;|&nbsp;<a href=""?UserSearch=1"">被锁住用户</a>&nbsp;|&nbsp;<a href=""?UserSearch=2"">所有管理员</a>&nbsp;|&nbsp;<a href=""?UserSearch=3"">待审批会员</a>&nbsp;|&nbsp;<a href=""?UserSearch=4"">待邮件激活</a>&nbsp;|&nbsp;<a href=""?UserSearch=5"">24小时内登录</a>&nbsp;|&nbsp;<a href=""?UserSearch=6"">24小时内注册</a>"
			Response.Write	" </ul>"
		...
		Sub Main()
		    Dim GroupID:GroupID=KS.G("GroupID")
				...
				sSQL = " UserID,UserName,GroupID,ChargeType,Point,BeginDate,LastLoginIP,LastLoginTime,LoginTimes ,locked,Edays,IsOnline"
...
若目前用户已经过了有效期，则有效期从续费之日起重新计数。</td>
		...
		sub SaveModify()
			dim UserID,UserName,RealName,Password,PwdConfirm,Question,Answer,Sex,Email,HomePage,QQ,MSN,GroupID,locked,DataCount,ChargeType,Point,Money,BeginDate,Edays,province,fax,UserFace,clubgradeid
			dim rsUser,sqlUser
			dim OfficeTel,Address,Sign
			dim IDCard,BirthDay,City,Zip,ICQ,UC
			Dim SchoolAge,UserWorking,HomeTel,Mobile
		...
		sub MoveUser()
            ...
            if DataBaseType=1 then
			    Conn.Execute("Update KS_User set UserTypes" & UserType & ",GroupIDs=" & GroupID & ",ChargeType =" & sChargeType & ",Point =" & sGroupPoint & ",BeginDate ='" & formatdatetime(now(),2) & "',EDays=" & sValidDays & " where UserID in (" & UserID & ")")
			else
