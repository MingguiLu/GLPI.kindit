...
Class SiteIndex
		...
		Sub GetProductList()
		 ...
		 SqlStr="select b.BlogName,b.userid,[domain],a.inputer,a.id,a.price_member,a.price_market,a.price,a.title,a.tid,a.prointro,a.PhotoUrl,a.recommend,a.popular,a.promodel,a.rank,a.adddate from KS_Product a inner join ks_blog b on a.inputer=b.username "&param& OrderStr
