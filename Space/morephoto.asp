...
Class Spacemore
  ...
  Sub PhotoList()
	 ...
	 if ks.s("key")<>"" then param=param & " and XCName like '%" & ks.r(ks.s("key")) &"%'"
	   ...
	   str=str & "<td style=""text-align:left"" colspan=2><strong>按相册名称搜索：</strong><input style=""border:1px #000 solid;height:18px;"" type=""text"" size=""12"" name=""key"">&nbsp;&nbsp;<input type=""submit"" value= "" 查 找 "" class=""btn""></td>"
	   str=str & "</form></tr>"
	   str=str & "</table><br/><br/>"
  End Sub
