   ...
   Do While Not RS.Eof
         %>
                         <tr class='tdbg' onMouseOver="this.className='tdbgmouseover'" onMouseOut="this.className='tdbg'">
                                            ...
                                            <td align="left">[<%=RS("FolderName")%>]<a title="<table width=80 border=0 align=center><tr><td><img src='<%=RS("PhotoUrl")%>' border=0 width='130' height='80'></td></tr></table>"  href="../<%=KS.C_S(ChannelID,10)%>/Show.asp?id=<%=rs("id")%>" target="_blank"><%=KS.GotTopic(trim(RS("title")),25)%></a></td>
							 ...
							 <% Call KSUser.GetClassByGroupID(ChannelID,ClassID,Selbutton) %>
							  ...
							  <tr class="tdbg">
							   ...
							   <tr class="tdbg">
                                       ...
                                       <textarea name="Content" style="width:200px;height:200px"><%=KS.HTMLCode(Content)%></textarea>
