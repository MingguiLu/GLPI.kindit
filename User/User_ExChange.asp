...
Class User_ExChange
	   ...
	   <script>
		...
		<FORM name=myform action="User_Exchange.asp" method="post">
		  ...
		  <Input style="TEXT-ALIGN: center" maxLength=8 size=6 value=100 name="Money"> 元兑换成<%=KS.Setting(45)%> &nbsp;&nbsp;&nbsp;&nbsp;<Font color=red>兑换比率：<%=KS.Setting(43)%>元:1<%=KS.Setting(46)%></Font> 
		     <br>
			 <%End If%>
		  ...
		  <Input type=radio value="2" name="ChangeType"<%IF Mid(KS.Setting(170),1,1)="0" then Response.Write " checked"%>>使用经验积分： 将 
				<Input style="TEXT-ALIGN: center" maxLength=8 size=6 value=100 name="Score"> 分兑换成<%=KS.Setting(45)%> &nbsp;&nbsp;&nbsp;&nbsp;<Font color=red>兑换比率：<%=KS.Setting(41)%>分:1<%=KS.Setting(46)%> </Font>
