  ...
  Function GetUserList()
		...
		If KS.S("page") <> "" Then
         ...
         GetUserList= GetUserList &"     </tr>" & vbnewline
			  ...
			  SqlStr="Select * From KS_User where groupid<>1 and username like '%" & KS.R(ks.s("username")) & "%' " & Param
			  else
			  SqlStr="Select * From KS_User where groupid<>1 " & Param
			  end if
			  RS.Open SqlStr,Conn,1,1
			       If Not RS.EOF  Then
							totalPut = Conn.Execute("select count(1) from ks_user where groupid<>1")(0)
		...
		Function ShowContent(RS,totalPut, MaxPerPage, CurrentPage,ListType)
		    Dim I,Privacy
              ...
              ShowContent = ShowContent & "  <td width=""9%""><img src=""images/m_list_49.gif"" align=""absmiddle""><a href=""../space/?" & RS("Username") & """ target=""_blank"">" & RS("UserName") & "</a></td>" & vbnewline
