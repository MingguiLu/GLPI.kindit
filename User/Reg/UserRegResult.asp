...
Class User_RegPost
		...
		Public Sub Kesion()
		 ...
		 Dim NewRegUserPoint:NewRegUserPoint=KS.Setting(40) : If Not IsNumeric(NewRegUserPoint) Then NewRegUserPoint=0
		  ...
		  If Instr(Lcase(Request.ServerVariables("HTTP_REFERER")),"?do=reg")=0 Then Call KS.Alert("请不要非法提交!","../") : Response.End
        ...
        End If
		 ...
		 CheckUrl=KS.GetDomain &"User/RegActive.asp?UserName=" & UserName &"&CheckNum=" & CheckNum
