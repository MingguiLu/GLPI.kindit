		...
		<script language = "JavaScript">
				...
				<table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="border">
                  <form  action="User_Class.asp?Action=<%=Action%>&ID=<%=KS.S("ID")%>" method="post" name="myform" id="myform" onSubmit="return CheckForm();">
                    ...
                    <tr class="tdbg">
                       <td class="clefttitle">选择类型：</td>
                       <td><select class="textbox" size='1' name='TypeID' style="width:250">
                     ...
                     <tr class="tdbg">
                              ...
                              <tr class="tdbg">
                                      ...
                                      <td><textarea name="Descript" style="width:90%;height:80px" class="textarea" id="Descript" cols=70 rows=6 ><%=descript%></textarea></td>
                              </tr>
