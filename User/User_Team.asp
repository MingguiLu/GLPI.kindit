...
<tr class="tdbg">
            ...
            <tr class="tdbg">
              ...
              <td><textarea class="textarea" name="Note" id="Note" style="height:80" cols=50 rows=5><%=Note%></textarea>              </td>
            </tr>
            <tr class="tdbg">
              <td class="clefttitle">圈子公告：</td>
              <td><textarea class="textarea" name="Announce" id="Announce" style="height:80" cols=50 rows=5><%=Announce%></textarea>              </td>
            </tr>
            <tr class="tdbg">
			  <td></td>
              <td height="30">
	   ...
	   Sub TeamIndex()
							...
							End If
								  ...
								  %>
				                     ...
				                     <table width="98%"  border="0" align="center" cellpadding="3" cellspacing="1" class="border">
                                                <tr class="title">
                                                  <td width="50%" style="height:22px">我创建的圈子</td>
                                                  <td width="50%">我参与讨论的圈子</td>
                                                </tr>
												<tr class='tdbg'>
												  <td valign="top">
                                 <%
