...
Class User_Message
       ...
       Public Sub loadMain()
		...
		<table width="98%" border="0" align="center" class="border" cellpadding="2" cellspacing="1" >
<tr class="tdbg">
								  ...
								  %>
				                    ...
				                    <table width="98%"  border="0" align="center" cellpadding="1" cellspacing="1" class="border">
                                                <tr class="title">
                                                  ...
                                                  <td width="33%" height="22" align="center">评论内容</td>
         ...
         %>
           <tr class='tdbg' onMouseOver="this.className='tdbgmouseover'" onMouseOut="this.className='tdbg'">
               <td class="splittd" height="22" align="center">
                ...
                <td class="splittd" align="left"><a href="../space/?<%=KSUser.UserName%>/log/<%=rs("logid")%>" target="_blank" class="link3"><%=KS.GotTopic(trim(RS("Content")),35)%></a>
...
%>
	   ...
	   Sub ReplayComment()
	     Call KSUser.InnerLocation("回复评论")
		  Dim KS_A_RS_Obj:Set KS_A_RS_Obj=Server.CreateObject("ADODB.RECORDSET")
		   KS_A_RS_Obj.Open "Select top 1 * From KS_BlogComment Where ID=" & KS.ChkClng(KS.S("ID")),Conn,1,1
		...
		<script language = "JavaScript">
				function CheckForm()
				{
				  if (CKEDITOR.instances.Replay.getData()=="")
					{
					  alert("请输入回复内容！");
					  CKEDITOR.instances.Replay.focus();
					  return false;
					}
				    ...
				    <tr class="title">
                      ...
                      <tr class="tdbg">
                           <td  height="25" align="center"><span>评论标题：</span></td>
                              <td>  <input class="textbox" name="Title" type="text" id="Title" style=" color:#999;border:1px solid #ccc;background:#FBFBFB;width:250px; " value="<%=Title%>" maxlength="100" />
                              ...
                              <tr class="tdbg">
                                  ...
                                  <td>
								  <textarea name="Content" style="color:#999;border:1px solid #ccc;background:#FBFBFB;overflow:auto;width:500px;height:70px"><%=Server.HtmlEncode(Content)%></textarea>
                ...
                CKEDITOR.replace('Content', {width:"98%",height:"150px",toolbar:"Basic",filebrowserBrowseUrl :"../editor/ksplus/SelectUpFiles.asp",filebrowserWindowWidth:650,filebrowserWindowHeight:290});
                              ...
                              <tr class="tdbg">
                                  ...
                                  <td>
								  <textarea name="Replay" style="color:#999;border:1px solid #ccc;background:#FBFBFB;overflow:auto;width:500px;height:70px"><%=Server.HtmlEncode(Replay)%></textarea>
					<!--<script type="text/javascript">
                CKEDITOR.replace('Replay', {width:"98%",height:"150px",toolbar:"Basic",filebrowserBrowseUrl :"../editor/ksplus/SelectUpFiles.asp",filebrowserWindowWidth:650,filebrowserWindowHeight:290});
			    </script> -->
	  ...
	  Sub CommentDel()
		...
		Dim RS:Set RS=Conn.Execute("Select * From KS_BlogComment Where UserName='" & KSUser.UserName & "' and ID In(" & ID & ")")
		Do While Not RS.EOF 
								  ...
								  %>
				                     ...
				                     <table width="98%"  border="0" align="center" cellpadding="3" cellspacing="1" class="border">
                                                <tr class="title">
                                                  <td width="6%" height="22" align="center">选中</td>
												  <td width="12%" height="22" align="center">发表人</td>
                                                  <td width="41%" height="22" align="center">留言内容</td>
                                                  <td width="12%" height="22" align="center">发表时间</td>
                                                  <td width="21%" height="22" align="center" nowrap>管理操作</td>
                                                </tr>
   ...
   Do While Not RS.Eof
         %>
                                          <tr class='tdbg' onMouseOver="this.className='tdbgmouseover'" onMouseOut="this.className='tdbg'">
                                            ...
                                            <td width="35%" class="splittd" align="left"><a href="../space/?<%=KS.C("UserID")%>/message#<%=rs("id")%>" target="_blank" class="link3"><%=KS.GotTopic(trim(KS.LoseHtml(RS("Content"))),35)%>...</a>
...
%>
	   ...
	   Sub ReplayMessage()
	     Call KSUser.InnerLocation("回复留言")
		  Dim KS_A_RS_Obj:Set KS_A_RS_Obj=Server.CreateObject("ADODB.RECORDSET")
		   KS_A_RS_Obj.Open "Select top 1 * From KS_BlogMessage Where ID=" & KS.ChkClng(KS.S("ID")),Conn,1,3
		   If KS_A_RS_Obj.Eof And KS_A_RS_Obj.Bof Then
			KS_A_RS_Obj.Close:Set KS_A_RS_Obj=Nothing
		    Response.Write "<script>alert('参数出错!');history.back();</script>"
			Response.end
                      ...
                      <tr class="tdbg" style="display:none">
                           <td  height="25" align="center"><span>留言标题：</span></td>
                              ...
                              <tr class="tdbg">
                                  ...
                                  <td><textarea  name="Content" style="color:#999;border:1px solid #ccc;background:#FBFBFB;overflow:auto;width:500px;height:70px" id="Content"><%=Server.HtmlEncode(Content)%></textarea>
				   </td>
                            </tr>
                              <tr class="tdbg">
                                  <td  height="25" align="center"><span>回复内容：</span></td>
	  ...
	  End Sub
		...
		<table width="98%" align="center" cellpadding="3" cellspacing="1" class="border">
				<form action="User_Message.asp"  name="myform" method="post" id="myform" onSubmit="return CheckForm();">
				  ...
				  <tr class='tdbg'> 
					...
					<td valign=middle>
					  <textarea cols=50 rows=16 name="message" id="message" style="display:none" title="Ctrl+Enter发送">
					  <%If KS.S("ID")<>"" Then%>
					...
					<%End If%>
					 ...
					 <script type="text/javascript" src="../editor/ckeditor.js" mce_src="../editor/ckeditor.js"></script>
					 <script type="text/javascript">
						CKEDITOR.replace('message', {width:"98%",height:"200px",toolbar:"Basic",filebrowserBrowseUrl :"../editor/ksplus/SelectUpFiles.asp",filebrowserWindowWidth:650,filebrowserWindowHeight:290});
					 </script>
		...
		② 标题最多<b>200</b>个字符，内容最多<b><%=max_sms%></b>个字符<br>
					</td>
				  </tr>
				  <tr class='tdbg'> 
		...
		Sub savemsg()
			...
			for i=0 to ubound(Incept)
				...
				Case "发送"
					SqlStr="insert into KS_Message (Incept,sEnder,title,content,SendTime,flag,IsSend,DelR,DelS) values ('"&sUname&"','"&KSUser.UserName&"','"&title&"','"&message&"'," & SqlNowString & ",0,1,0,0)"
					Subtype="已发送信息"
				Case "保存"
					SqlStr="insert into KS_Message (Incept,sEnder,title,content,SendTime,flag,IsSend,DelR,DelS) values ('"&sUname&"','"&KSUser.UserName&"','"&title&"','"&message&"'," & SqlNowString & ",0,0,0,0)"
					Subtype="发件箱"
				Case Else
					SqlStr="insert into KS_Message (Incept,sEnder,title,content,SendTime,flag,IsSend,DelR,DelS) values ('"&sUname&"','"&KSUser.UserName&"','"&title&"','"&message&"'," & SqlNowString & ",0,1,0,0)"
					Subtype="已发送信息"
