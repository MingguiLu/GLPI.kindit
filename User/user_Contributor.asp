						...
						<%if F_B_Arr(9)=1 Then%>	  
                              <tr class="tdbg">
								 ...
								 <script type="text/javascript">
									CKEDITOR.replace('Content', {width:"95%",height:"350px",toolbar:"NewsTool",filebrowserBrowseUrl :"../Include/SelectPic.asp?from=ckeditor&Currpath=<%=KS.GetUpFilesDir()%>",filebrowserWindowWidth:650,filebrowserWindowHeight:290});
									</script>
								</td>
                            </tr>
					    <%end if%>
							 ...
							 <input type="hidden" name="ClassID" value="<%=classid%>">
							  ...
							  <tr class="tdbg">
							   ...
							   <tr class="tdbg">
								...
								<script type="text/javascript" src="../editor/ckeditor.js" mce_src="../editor/ckeditor.js"></script>
								 <script type="text/javascript">
									CKEDITOR.replace('Content', {width:"95%",height:"150px",toolbar:"Basic",filebrowserBrowseUrl :"../Include/SelectPic.asp?from=ckeditor&Currpath=<%=KS.GetUpFilesDir()%>",filebrowserWindowWidth:650,filebrowserWindowHeight:290});
									</script> 
									   </td>
                                </tr>
                                <%end if
...
<script type="text/javascript" src="../editor/ckeditor.js" mce_src="../editor/ckeditor.js"></script>
								 <script type="text/javascript">
									CKEDITOR.replace('GQContent', {width:"95%",height:"150px",toolbar:"Basic",filebrowserBrowseUrl :"../Include/SelectPic.asp?from=ckeditor&Currpath=<%=KS.GetUpFilesDir()%>",filebrowserWindowWidth:650,filebrowserWindowHeight:290});
									</script> 											         </td>
                </tr>
				 <tr class="tdbg">
