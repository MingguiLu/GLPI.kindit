...
END IF
	...
	Dim UserLoginTF:UserLoginTF=Cbool(KSUser.UserLoginChecked)
	   ...
	   End Sub
	   Sub GetNoLoginInfo()
		   ArticleContent="<div align=center>对不起，你还没有登录，本文至少要求本站的注册会员才可查看!</div><div align=center>如果你还没有注册，请<a href=""../?do=reg""><font color=red>点此注册</font></a>吧!</div><div align=center>如果您已是本站注册会员，赶紧<a href=""../user/login/""><font color=red>点此登录</font></a>吧！</div>"
	   End Sub
	   Sub GetContent()
