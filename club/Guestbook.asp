		...
		Public Sub Kesion()
			...
			Set KMRFObj = New Refresh
		          If KS.Setting(114)="" Then KS.Die "请先到""基本信息设置->模板绑定""进行模板绑定操作!"
				   ...
				   FileContent=Replace(FileContent,"{$PostButtonAction}","<a href=""" & KS.Setting(3) & KS.Setting(66) & "/post.asp""><img src=""" & KS.Setting(3) & KS.Setting(66) & "/images/button_post.png"" align=""absmiddle"" alt=""发帖""></a>")
...
Do While Not RSObj.Eof and Loopno > 0
          ...
          ListStr = ListStr & "                    <tr>"
          ListStr = ListStr & "                      <td width='49%'><img src='../editor/ubb/images/smilies/default/" & replace(RSObj("TxtHead"),"Face.gif","01.gif") & "' align='absmiddle'> 主题：" & RSObj("Subject") & "</td><td width='51%' align='right'>" & vbcrlf
          ...
          ListStr = ListStr & "      <a href='#'><img src='images/home-gray.gif' width='16' height='16' border='0' align='absmiddle' alt='主页'></a>" &vbcrlf
           ...
           ListStr = ListStr & "                       <a href='#'><img src='images/email-gray.gif' width='18' height='18' border='0' align='absmiddle' alt='电子邮件'></a>" & vbcrlf
            ...
            End If
             ...
             ListStr = ListStr & "             <td><img src='../editor/ubb/images/smilies/default/" & rs(2) & ".gif' align='absmiddle'>&nbsp;<font color=red>" & KS.HtmlCode(RS(0)) & "</font><div align=right>回复时间：&nbsp;" & Rs(1) & "</div></td></tr>"
             End If
