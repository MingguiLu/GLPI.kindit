...
Class ClassCls
		...
		'添加频道或目录的过程
			...
			Sub GetAddChannelFolder(Action,FolderID, FormProcesPage)
			 ...
			 Dim Folder,CurrPath,TemplateRS, TemplateSql, TypeList, NowDate, YearStr, MonthStr, DayStr,DefaultArrGroupID,ReadPoint,ChargeType,PitchTime,ReadTimes,AllowArrGroupID,DividePercent,K,PubTF,MailTF
			...
			With Response
				...
				.Write  "<td>"
				If Action="Edit" Then
				.Write "   &nbsp;<input type='hidden' id='ChannelID' name='ChannelID' value='" & ChannelID & "'><select Disabled name='ChannelIDs' class='upfile' onchange='changemodel(this.value)'>" & vbCrLf
				Else
				.Write "   &nbsp;<select name='ChannelID' id='ChannelID' class='upfile' onchange='changemodel(this.value)'>" & vbCrLf
			...
			Dim TemplateID, FnameType, FsoType, FolderDomain, FolderOrder, CurrPath, TopFlag,ClassType,WapSwitch,WapFolderTemplateID,WapTemplateID,PubTF,MailTF
