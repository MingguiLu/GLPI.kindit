...
Class RefreshLocationCls
		...
		Function GetIndexLocation(StartTag, NaviStr, OpenType, TitleCss)
		   ...
		   Select Case UCase(FCls.RefreshType)
			 ...
			 case "ZHAOPIN" str= "<a " & TitleCss & " href=""" & JLCls.GetJobHomeUrl & """" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "企业招聘" 
			 case "QIUZHI" str= "<a " & TitleCss & " href=""" & JLCls.GetJobHomeUrl & """" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "个人求职" 
