...
Function GetVoteStr()
	...
	VoteStr=VoteStr & "<table border=""0"" width=""100%"" cellspacing=""0"" cellpadding=""0""><tr><td class=""mood_top"" colspan=""15"">您看到此" & KS.C_S(ChannelID,4) & KS.C_S(ChannelID,3) & "时的感受：已有 <span style=""color:red;font-size:18px;font-weight:bold"">" & TotalVote & "</span> 人表态!</td></tr><tr>"
