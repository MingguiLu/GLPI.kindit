...
Class FriendLinkReg
		...
		Public Sub Kesion()
			...
			Response.Write "         <table border=""0"" cellpadding=""2"" cellspacing=""1"" width=""600""  class=""table_border"">" & vbCrLf
			Response.Write "         <tr class=""link_table_title"">" & vbCrLf
			Response.Write "           <td colspan=2>本站链接信息</td>" & vbCrLf
			Response.Write "         </tr>" & vbCrLf
			Response.Write "         <tr>" & vbCrLf
			Response.Write "           <td colspan=""2"" align=""left""><div class=""linetext"">申请链接交换，请在您的网站上先做好本站的链接，再提交友情链接申请。</div></td>"
			Response.Write "         </tr>" & vbCrLf
			Response.Write "         <tr>" & vbCrLf
			Response.Write "           <td width=""176"" height=""30"" align=""center"" class=""linetext"" valign=""middle""><strong>※本站文字链接代码:</strong></td>"
			Response.Write "           <td width=""313"" height=""30""><div class=""linetext"" align=""center"">演示：<a href=""" & KS.Setting(2) & """ title=""" & KS.Setting(1) & """ target=""_blank"">" & KS.Setting(0) & "</a></div></td>"
			Response.Write "         </tr>" & vbCrLf
			Response.Write "         <tr align=""center"">" & vbCrLf
			Response.Write "           <td height=""30"" colspan=""2"" > <textarea name=""textlink"" rows=""2"" onMouseOver=""javascript:this.select();"" style=""width:88%;border-style: solid; border-width: 1""><a href=""" & KS.Setting(2) & """ title=""" & KS.Setting(1) & """ target=""_blank"">" & KS.Setting(0) & "</a></textarea></td>"
			Response.Write "         </tr>" & vbCrLf
			Response.Write "         <tr>" & vbCrLf
			Response.Write "           <td width=""176"" height=""30"" class=""linetext"" align=""center""><strong>※本站LOGO链接代码:</strong></td>"
			Response.Write "           <td height=""30""><div class=""linetext"" align=""center"">演示:<a href=""" & KS.Setting(2) & """ title=""" & KS.Setting(1) & """ target=""_blank""><img src=""" & Replace(KS.Setting(4),"{$GetInstallDir}",KS.Setting(3)) & """ width=""88"" height=""31"" border=""0"" align=""absmiddle""></a></div></td>"
			Response.Write "         </tr>" & vbCrLf
			Response.Write "         <tr align=""center"">" & vbCrLf
			Response.Write "           <td height=""30"" colspan=""2""> <textarea name=""logolink"" rows=""2"" onMouseOver=""javascript:this.select();"" style=""width:88%;border-style: solid; border-width: 1""><a href=""" & KS.Setting(2) & """ title=""" & KS.Setting(1) & """ target=""_blank""><img src=""" & KS.Setting(4) & """ width=""88"" height=""31"" border=""0""></a></textarea></td>"
			Response.Write "         </tr>" & vbCrLf
			Response.Write "       </table>" & vbCrLf
			Response.Write "         <br>" & vbCrLf
			Response.Write "         <table width=""600"" border=""0"" cellspacing=""0"" cellpadding=""0"" class=""table_border"">" & vbCrLf
			Response.Write "           <tr class=""link_table_title"">" & vbCrLf
			...
			Response.Write "              <div align=""center"" class=""linetext"">网站名称</div></td>" & vbCrLf
			Response.Write "            <td width=""542"" height=""30"" class=""linetext"">" & vbCrLf
			...
			Response.Write "          </tr>" & vbCrLf
			Response.Write "          <tr>" & vbCrLf
			Response.Write "            <td height=""30"" align=""center"" class=""linetext"">所属类别</td>" & vbCrLf
			...
			Response.Write "              <div align=""center"" class=""linetext"">网站站长</div></td>" & vbCrLf
			Response.Write "            <td height=""30""  class=""linetext"">" & vbCrLf
			Response.Write "              <input name=""WebMaster"" class=""textbox"" type=""text"" size=""38""> <font color=""red"">(*必须填写)</font></td>"
			Response.Write "          </tr>" & vbCrLf
			Response.Write "          <tr>" & vbCrLf
			Response.Write "            <td height=""30"" align=""center"">" & vbCrLf
			Response.Write "              <div align=""center"" class=""linetext"">站长信箱</div></td>" & vbCrLf
			Response.Write "            <td height=""30"">" & vbCrLf
			...
			Response.Write "          <tr>" & vbCrLf
			Response.Write "            <td height=""30"" align=""center"">" & vbCrLf
			Response.Write "              <div align=""center"" class=""linetext"">网站密码</div></td>" & vbCrLf
			Response.Write "            <td height=""30"" class=""linetext"">" & vbCrLf
			Response.Write "              <input name=""PassWord"" type=""password"" class=""textbox"" size=""42"" > <font color=""red"">(*必须填写,且不少于6位)</font></td>"
			Response.Write "          </tr>" & vbCrLf
			Response.Write "          <tr>" & vbCrLf
			Response.Write "            <td height=""30"" align=""center"" class=""linetext"">确定密码</td>" & vbCrLf
			Response.Write "            <td height=""30"" class=""linetext"">" & vbCrLf
			...
			Response.Write "          <tr>"
			Response.Write "            <td height=""30"" align=""center"" class=""linetext"">网站地址</td>" & vbCrLf
			Response.Write "            <td height=""30"" class=""linetext""><input name=""Url"" class=""textbox"" type=""text""  value=""http://"" id=""Url"" size=""38""> <font color=""red"">(*必须填写,且必须输入http://)</font></td>"
			Response.Write "          </tr>" & vbCrLf
			Response.Write "          <tr>"
			Response.Write "            <td height=""30"" align=""center"" class=""linetext"">链接类型</td>" & vbCrLf
			Response.Write "            <td height=""30"" class=""linetext"">"
			...
			Response.Write "            <td height=""30"" align=""center"" class=""linetext"">Logo 地址</td>" & vbCrLf
			Response.Write "            <td height=""30""  class=""linetext""><input name=""Logo"" class=""textbox"" type=""text""  value=""http://"" id=""Logo"" size=""38""> <font color=""red"">(*必须填写)</font></td>"
			Response.Write "          </tr>" & vbCrLf
			Response.Write "          <tr>" & vbCrLf
			Response.Write "            <td height=""30"" align=""center"">"
			Response.Write "              <div align=""center"" class=""linetext"">网站简介</div></td>" & vbCrLf
			Response.Write "            <td height=""30"">" & vbCrLf
			...
			Response.Write "          </tr>" & vbCrLf
			Response.Write "          <tr>" & vbCrLf
			Response.Write "            <td height=""30"" align=""center"" class=""linetext"">认 证 码</td>" & vbCrLf
			Response.Write "            <td height=""30"" class=""linetext"">" & vbCrLf
			Response.Write "            <input name=""Verifycode""  class=""textbox"" type=""text"" size=""8"" >  <IMG style=""cursor:pointer;"" src=""../../../plus/verifycode.asp?n=" & Timer & """ onClick=""this.src='../../../plus/verifycode.asp?n='+ Math.random();"" align=""absmiddle""></td>" & vbCrLf
			Response.Write "          </tr>" & vbCrLf
			Response.Write "        </table>" & vbCrLf
			Response.Write "       </td>"
			Response.Write "    </tr>" & vbCrLf
