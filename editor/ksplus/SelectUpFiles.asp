...
Class InsertPicture
	   ...
	   Sub CheckUser()
	     IF Cbool(KSUser.UserLoginChecked)=false Then
		  ...
		  Exit Sub
		 End If
		 response.write "<iframe src='" &  KS.Setting(3) & "user/SelectPhoto.asp?CKEditorFuncNum=" & request("CKEditorFuncNum")&"&from=ckeditor&ChannelID=999' frameborder='0' scrolling='auto' width='100%' height='100%'></iframe>"
	   End Sub
End Class
%>
